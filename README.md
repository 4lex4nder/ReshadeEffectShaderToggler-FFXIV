...
# Requirements
* [REST v1.3.19](https://github.com/4lex4nder/ReshadeEffectShaderToggler/releases/tag/v1.3.19), note that the ReShade installer may provide a different version. The configuration is only tested against this version
